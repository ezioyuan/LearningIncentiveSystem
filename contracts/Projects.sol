...
contract ProjectList {
    ...
    function createProject(string _description, uint _minInvest, uint _maxInvest, uint _goal, uint _startTime,
    uint _endTime, uint _percent) public {
        address newProject = new Project(_description, _minInvest, _maxInvest, _goal, _startTime, _endTime, _percent,
         msg.sender);
...
contract Project {
    ...
    constructor(string _description, uint _minInvest, uint _maxInvest, uint _goal, uint _startTime,
    uint _endTime, uint _percent, address _owner) public {
    ...
    function createPayment(string _description, uint _amount, address _receiver, uint _percent)
    ownerOnly public {
    ...
    function getSummary() public view returns (string, uint, uint, uint, uint, uint, uint, uint, uint, uint,  address) {
        return (
            description,
            minInvest,
            maxInvest,
